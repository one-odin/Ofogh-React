...
const AddNewAd: React.FC = () => {
  ...
  const initialValues = { title: "", address: "", description: "" };

  const newAdHandler = async (values: adTypes): Promise<void> => {
    const newData = {
      title: values.title,
                  ...
                  <div className="mb-4">
                    ...
                    <div className="flex gap-2">
                      <div className="w-full">
                        <div className="border border-gray-300 dark:border-gray-500 dark:bg-slate-700 w-full h-5 rounded-md mb-1 text-gray-900 dark:text-gray-300 text-sm px-2">{latitude}</div>
                        <div className="border border-gray-300 dark:border-gray-500 dark:bg-slate-700 w-full h-5 rounded-md text-gray-900 dark:text-gray-300 text-sm px-2">{longitude}</div>
                      </div>
                      <SelectMapModal setLatitude={setLatitude} setLongitude={setLongitude} />
                    </div>
